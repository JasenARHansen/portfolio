...
public class GoogleBitMap {
    ...
    private static void floodFill(boolean color, int x, int y, int scale, JLabel jLabel, BufferedImage image) {
        /*
        ...
        while (!floodQueue.isEmpty()) {
            ...
            if ((temp != -1) && (temp != colorValue)) {
                ...
                if ((0 <= (newX + 1)) && ((newX + 1) < imageWidth) && (0 <= (newY)) && ((newY) < imageHeight)
                ...
                if ((0 <= (newX)) && ((newX) < imageWidth) && (0 <= (newY + 1)) && ((newY + 1) < imageHeight)
                        && (image.getRGB((newX), (newY + 1)) != colorValue)) {
                    floodQueue.add(new GoogleTuple<>(newX, (newY + 1)));
                }
                if ((0 <= (newX)) && ((newX) < imageWidth) && (0 <= (newY - 1)) && ((newY) < imageHeight)
                        && (image.getRGB((newX), (newY - 1)) != colorValue)) {
                    floodQueue.add(new GoogleTuple<>(newX, (newY - 1)));
                }
            }
    ...
    static class GoogleTuple<X extends Comparable<X>, Y extends Comparable<Y>> implements Comparable<GoogleTuple<X, Y>> {
