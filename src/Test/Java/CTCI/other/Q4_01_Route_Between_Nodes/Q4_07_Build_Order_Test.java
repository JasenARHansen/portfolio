...
import Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.DFS.Graph;
import Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.DFS.Project;
...
public class Q4_07_Build_Order_Test {
    ...
    public static String[] buildOrderWrapper_Edge_Removal(
        ...
        Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] buildOrder =
    ...
    public static String[] convertToStringList_Edge_Removal(
            Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] projects) {
    ...
    public static Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[]
    findBuildOrder(String[] projects, String[][] dependencies) {
        Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph graph =
     ...
     * before b. */
    public static Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph
    buildGraph_Edge_Removal(String[] projects, String[][] dependencies) {
        Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph graph =
                new Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph();
    ...
    orderProjects_Edge_Removal(
            ArrayList<Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project>
                    projects) {
        Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] order =
                new Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project
                        [projects.size()];
        ...
        while (toBeProcessed < order.length) {
            Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project current =
                    order[toBeProcessed];
            ...
            ArrayList<Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project> children =
                    current.getChildren();
            for (Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project child :
                    children) {
    ...
    public static int addNonDependent(
            Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] order,
            ArrayList<Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project> projects,
            int offset) {
        for (Code.Java.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project project :
                projects) {
