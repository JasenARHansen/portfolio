package Test.Java.Interview.FirstQuadrant;

import Code.Java.Interview.FirstQuadrant.RomanNumeral;
...
public class RomanNumeralTest {
    ...
    public void test_RomanNumeral_Conversion_To_Int_Complex_Output_Multiple_Input() {
        System.out.format("Test: %s\n", name.getMethodName());
        RomanNumeral.conversion_To_Int_Output_Complex("(XX+CMXCIX)/V", "(I+v+X+CM+XC+IX)/V", "(XX+CIMXCIX)/V");
        System.out.format("\n");
        String testConversion = RomanNumeral.conversion_To_Int_Complex("(XX+CMXCIX)/V");
        assertEquals("Test RomanNumeral Conversion Complex: (XX+CMXCIX)/V", testConversion, "(20+999)/5");
        testConversion = RomanNumeral.conversion_To_Int_Complex("(I+v+X+CM+XC+IX)/V");
    ...
    public void test_RomanNumeral_Conversion_To_Int_Output_Simple_Array() {
        ...
        testValue = RomanNumeral.conversion_To_Int("MIM");
    ...
    public void test_RomanNumeral_Conversion_To_Int_Output_Simple_With_Logs_Array() {
        ...
        testValue = RomanNumeral.conversion_To_Int("MIM");
        assertEquals("Test RomanNumeral Conversion (Invalid): MIM", -1, testValue);
        testValue = RomanNumeral.conversion_To_Int("K");
        assertEquals("Test RomanNumeral Conversion (Invalid): K", -1, testValue);
        testValue = RomanNumeral.conversion_To_Int("IIII");
    ...
    public void test_RomanNumeral_Conversion_To_Numeral_4000() {
        ...
        assertEquals("Test RomanNumeral Conversion (Invalid): 4000", RomanNumeral.errorString, testValue);
    }
