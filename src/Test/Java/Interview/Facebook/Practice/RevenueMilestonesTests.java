...
import Code.Java.Interview.Facebook.Practice.RevenueMilestones;
...
public class RevenueMilestonesTests {
    ...
    public void getMilestoneDays_1() {
        ...
        System.out.format("%s: With an income of '%s', the milestones '%s' were reached on these days '%s'\n", name.getMethodName(), Arrays.toString(revenues), Arrays.toString(milestones), Arrays.toString(result));
