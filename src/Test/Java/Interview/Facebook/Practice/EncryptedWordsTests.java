...
import Code.Java.Interview.Facebook.Practice.EncryptedWords;
...
public class EncryptedWordsTests {
    ...
    public void findEncryptedWord_1() {
        ...
        System.out.format("%s: The value '%s' is encrypted as '%s'\n", name.getMethodName(), input, result);
    ...
    public void findUnEncryptedWord_1() {
        ...
        System.out.format("%s: The value '%s' is unencrypted as '%s'\n", name.getMethodName(), input, result);
        assertEquals(expected, result);
    }
