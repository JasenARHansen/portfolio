...
import Code.Java.Interview.Facebook.Practice.CountingTriangles;
import Code.Java.Interview.Facebook.Practice.CountingTriangles.Sides;
...
public class CountingTrianglesTests {
    ...
    public void countDistinctTriangles_1() {
        ...
        System.out.format("%s: The set %d triangles has %d distinct triangles.\n", name.getMethodName(), inputs.size(), result);
