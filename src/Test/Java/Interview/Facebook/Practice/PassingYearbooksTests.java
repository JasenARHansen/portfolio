...
import Code.Java.Interview.Facebook.Practice.PassingYearbooks;
...
public class PassingYearbooksTests {
    ...
    public void findSignatureCounts_1() {
        ...
        System.out.format("%s: The yearbooks for the initial mix '%s' has the following number of signatures '%s'\n", name.getMethodName(), Arrays.toString(values), Arrays.toString(result));
