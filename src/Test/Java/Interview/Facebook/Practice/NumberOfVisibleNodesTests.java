...
import Code.Java.Interview.Facebook.Practice.NumberOfVisibleNodes;
import Code.Java.Interview.Facebook.Practice.NumberOfVisibleNodes.Node;
...
public class NumberOfVisibleNodesTests {
    ...
    public void visibleNodes_1() {
        ...
        System.out.format("%s: The are %d nodes visible from the left\n", name.getMethodName(), expected);
