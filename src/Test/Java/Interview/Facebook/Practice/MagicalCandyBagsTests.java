...
import Code.Java.Interview.Facebook.Practice.MagicalCandyBags;
...
public class MagicalCandyBagsTests {
    ...
    public void maxCandies_1() {
        ...
        System.out.format("%s: After eating candy %d times from the candy bags '%s', %d pieces of candy have been eaten.\n", name.getMethodName(), k, Arrays.toString(values), result);
