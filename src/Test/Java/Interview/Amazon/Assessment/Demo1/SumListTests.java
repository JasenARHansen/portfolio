package Test.Java.Interview.Amazon.Assessment.Demo1;

import Code.Java.Interview.Amazon.Assessment.Demo1.SumList;
...
public class SumListTests {
    ...
    public void sumList() {
        ...
        System.out.format("%s: The sum of the list '%s' is: %d\n", name.getMethodName(), values, result);
