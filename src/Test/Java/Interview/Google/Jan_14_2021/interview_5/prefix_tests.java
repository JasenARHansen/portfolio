...
import Code.Java.Interview.Google.Jan_14_2021.interview_5.Prefix;
...
public class prefix_tests {
    ...
    public void longestPrefix_1() throws Exception {
        ...
        String result = Code.Java.Interview.Google.Jan_14_2021.interview_5.Prefix.longestPrefix(inputs);
        System.out.format(
