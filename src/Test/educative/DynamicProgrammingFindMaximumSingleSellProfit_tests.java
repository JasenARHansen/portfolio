...
import Code.educative.DynamicProgrammingFindMaximumSingleSellProfit;
...
public class DynamicProgrammingFindMaximumSingleSellProfit_tests {
  ...
  public void find_stock_prices_1() {
    ...
    System.out.format(
            ...
            name.getMethodName(), Arrays.toString(values), result[0], result[1], result[1] - result[0]);
  ...
  public void find_stock_prices_3() {
    ...
    System.out.format(
            "%s: Given the prices '%s' to get the maximum profit or minimum loss is the profit is %d and "
                    + "the sell price is %d.\n",
            name.getMethodName(), Arrays.toString(values), result[0], result[1]);
    assertEquals(Arrays.toString(expected), Arrays.toString(result));
  }
