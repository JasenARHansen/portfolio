...
import CTCI.other.Ch_04_Trees_and_Graphs.GraphAdjacencyMatrix;
import CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.DFS.Graph;
import CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.DFS.Project;
...
public class Q4_07_Build_Order_Test {
    ...
    public static String[] buildOrderWrapper_Edge_Removal(
        ...
        CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] buildOrder =
    ...
    public static String[] convertToStringList_Edge_Removal(
            CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] projects) {
    ...
    public static CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[]
    findBuildOrder(String[] projects, String[][] dependencies) {
        CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph graph =
     ...
     * before b. */
    public static CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph
    buildGraph_Edge_Removal(String[] projects, String[][] dependencies) {
        CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph graph =
                new CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph();
    ...
    orderProjects_Edge_Removal(
            ArrayList<CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project>
                    projects) {
        CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] order =
                new CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project
                        [projects.size()];
        ...
        while (toBeProcessed < order.length) {
            CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project current =
                    order[toBeProcessed];
            ...
            ArrayList<CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project> children =
                    current.getChildren();
            for (CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project child :
                    children) {
    ...
    public static int addNonDependent(
            CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[] order,
            ArrayList<CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project> projects,
            int offset) {
        for (CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project project :
                projects) {
