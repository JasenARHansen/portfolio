...
import interview.Facebook.Feb_1_2021.practice.MatchingPairs;
...
public class MatchingPairs_tests {
    ...
    public void matchingPairs_1() {
        ...
        System.out.format(
                "%s: Comparing '%s' to '%s' after exchanging 2 characters in '%s' results in %d matches\n",
