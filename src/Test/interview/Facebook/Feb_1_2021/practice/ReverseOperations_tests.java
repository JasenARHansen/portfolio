...
import interview.Facebook.Feb_1_2021.practice.ReverseOperations;
import interview.Facebook.Feb_1_2021.practice.ReverseOperations.Node;
...
public class ReverseOperations_tests {
    ...
    public void reverse_1() {
        ...
        System.out.format(
                ...
                name.getMethodName(), Arrays.toString(array), Arrays.toString(result), result);
