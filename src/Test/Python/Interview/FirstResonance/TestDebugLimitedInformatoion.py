...
import src.Code.Python.Interview.FirstResonance.DebugLimitedInformation as baseFile
from src.Code.Python.Interview.FirstResonance.DebugLimitedInformation import DebugLimitedInformation
