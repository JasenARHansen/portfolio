package Code.Java.CTCI.other.Ch_04_Trees_and_Graphs.old;

import Code.Java.unsorted.classes.classesInstance.BinarySearchTreeHeightBalanced;
import Code.Java.unsorted.classes.classesInstance.Graph;
import Code.Java.unsorted.classes.classesInstance.NodeGraph;
...
public class Trees_And_Graphs_Tests {
    ...
    public <X extends Comparable<X>, Y, Z> void listOfPaths() {
        ...
        Integer[] array = {23, 127, 234, 19, 8, 3};
        BinarySearchTreeHeightBalanced<Integer> tree = Trees_And_Graphs.convertToBST(array);
        List<ArrayList<NodeTree<Integer>>> lists = Trees_And_Graphs.listOfDepths(tree);
