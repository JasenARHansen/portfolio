package Code.Java.Interview.Google.Jan_14_2021.interview_4;
...
public class Sequence {
  ...
  Define "X of a kind" as X cards of the same number. (X>=2) Define an algorithm to determine if the deck can be fully
  ...
  */
  ...
  // If I had time I would have sorted the keyset
  ...
  // I would repeat the above until the count of the start bucket was 0 and than mofe to the next
  // start bucket.
