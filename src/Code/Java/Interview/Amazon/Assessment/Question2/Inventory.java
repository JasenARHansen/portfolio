package Code.Java.Interview.Amazon.Assessment.Question2;
    ...
    public static List<Integer> numberOfItems(String s, List<Integer> startIndices, List<Integer> endIndices) {
        ...
        while ((!startIndices.isEmpty()) && (!endIndices.isEmpty())) {
            ...
            if ((0 <= start) && (stop <= s.length())) {
                ...
                int section_Start = 0;
                // Find first boundary
                while ((section_Start < section.length()) && (section.charAt(section_Start) != compartment)) {
                    section_Start++;
                }
                ...
                while (section_Start < section.length()) {
                    ...
                    if ((section_Start < section.length()) && (section.charAt(section_Start) == compartment)) {
                        section_Start++;
                        count += sub_count;
                    }
                }
