package Code.Java.Interview.Amazon.Assessment.Question1;
...
public class Fulfillment {
    public static void getDescription() {
        System.out.println("""
                An Amazon Fulfillment Associate has a set of items that need to be packed into 2 boxes.  Given an integer array of
