package Code.Java.Interview.SnapChat;

public class SnapChat {

    public static void main(String[] args) throws Exception {

        String[][] inputArray = {{"A", "T", "Y", "B"}, {"A", "Y", "V", "Q"}, {"D", "N", "L", "T"},
                {"R", "Q", "Y", "B"}};
    ...
    public static boolean pathDetected(String inputString, String[][] searchArray) {
        ...
        for (int outerSearchIndex = 0; outerSearchIndex < searchArray.length; outerSearchIndex++) {
            for (int innerSearchIndex = 0; innerSearchIndex < searchArray[outerSearchIndex].length; innerSearchIndex++) {
                if (subProcessing(inputString, 0, outerSearchIndex, innerSearchIndex, searchArray, visitedArray)) {
                    return true;
                }
            }
        }
    ...
    private static boolean subProcessing(String inputString, int stringIndex, int outerSearchIndex,
                                         int innerSearchIndex, String[][] searchArray, boolean[][] visitedArray) {
        ...
        // OuterSearinnerSearchIndexchIndex out of bounds
        ...
        if (!searchArray[outerSearchIndex][innerSearchIndex]
                .equals(inputString.substring(stringIndex, stringIndex + 1))) {
            return false;
        }
        ...
        boolean found = subProcessing(inputString, stringIndex + 1, outerSearchIndex + 1, innerSearchIndex, searchArray,
                visitedArray);
        ...
        // Case 2: outerIndex - 1
        if (!found) {
            if (subProcessing(inputString, stringIndex + 1, outerSearchIndex - 1, innerSearchIndex, searchArray,
                    visitedArray)) {
                found = true;
            }
        }
        ...
        // Case 3: innerIndex + 1
        if (!found) {
            if (subProcessing(inputString, stringIndex + 1, outerSearchIndex, innerSearchIndex + 1, searchArray,
                    visitedArray)) {
                found = true;
            }
        }
