package Code.Interview.Amazon.Assessment.Question2;
...
public class Inventory {
    /*
    I had a lot of trouble with the assessment tool.  It showed errors where there were not any and the descriptions were
    ambiguous.  Since I had technical issues I was unable to finish, so I implemented the code again from memory.
    ...
    public static void getDescription() {
        System.out.println("""
                ...
                Write a method that takes:
                 ...
                 2. A list of starting indexes for examination ranges
                 3. A list of stopping indexes for examination ranges
                For each pair os starting and stopping indexes dine the items in the closed containers.""".indent(2));
    }
