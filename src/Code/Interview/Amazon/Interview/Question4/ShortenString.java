package Code.Interview.Amazon.Interview.Question4;
...
public class ShortenString {
  ...
  */
    ...
    public static String Shorten(String input_string, int prefix_size) {
        ...
        return input_string.substring(0, prefix_size) +
                (input_string.length() - prefix_size - 1) +
                input_string.charAt(input_string.length() - 1);
    }
