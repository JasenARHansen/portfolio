...
import src.Python.Code.CtCI.ch_1_Arrays_and_Strings.URLify as baseFile
from src.Python.Code.CtCI.ch_1_Arrays_and_Strings.URLify import URLify
...
class TestURLify(unittest.TestCase):
    ...
    def test_urlify(self) -> None:
        ...
        # str1, result
        test_cases = {
            ("I will be an url      ", "I%20will%20be%20an%20url"),
            ("      I will be an url", "I%20will%20be%20an%20url"),
            ("      I will be an url      ", "I%20will%20be%20an%20url")
        }

        for first, expected in test_cases:
            result = URLify.urlify(to_url=first)
