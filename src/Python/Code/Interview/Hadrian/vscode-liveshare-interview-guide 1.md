...
### Step 3: Sign In to Live Share

You'll need a Microsoft or GitHub account to use Live Share:

1. Look for the **Live Share** button in the bottom status bar (it looks like a person icon or may say "Live Share")
2. Click the Live Share button
3. Select **"Sign In"** from the menu
4. Choose either **Microsoft** or **GitHub** account
5. A browser window will open - complete the sign-in process
6. Close the browser and return to VS Code

## During Your Interview

### Joining the Interview Session
...
- **See and edit code in real-time** - Both you and your interviewer can write code simultaneously
- **Navigate freely** - You can browse any files in the shared project
- **Run and debug** - Your interviewer may share terminals or debugging sessions with you
- **Ask questions** - Communicate with your interviewer via audio/video call (using your company's preferred tool)
