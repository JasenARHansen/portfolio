...
TEST(Udemy_Section1Test, hello_eq) {
    auto expected = "!!! Hello there World!!!";
    auto result = Section1::hello();
    EXPECT_EQ(expected, result);
}

TEST(Udemy_Section1Test, hello_neq) {
    auto expected = "Cat";
    auto result = Section1::hello();
    EXPECT_NE(expected, result);
}

TEST(Udemy_Section1Test, helloOutEndl_eq) {
    auto expected = "!!! Hello there World!!!\n";
...
TEST(Udemy_Section1Test, helloOutEndl_neq) {
    auto expected = "Cat";
    testing::internal::CaptureStdout();
    Section1::helloOutEndL();
...
TEST(Udemy_Section1Test, helloOutFlush_eq) {
    auto expected = "!!! Hello there World!!!";
    testing::internal::CaptureStdout();
...
TEST(Udemy_Section1Test, helloOutFlush_neq) {
    auto expected = "Cat";
    testing::internal::CaptureStdout();
    Section1::helloOutFlush();
    EXPECT_NE(expected, testing::internal::GetCapturedStdout());
