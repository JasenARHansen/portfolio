...
TEST(Interview_ScoreboardInferenceCh1Test, description) {
    testing::internal::CaptureStdout();
    ScoreboardInference::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_1) {
    auto expected = 4;
    auto n = 10;
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_2) {
    auto expected = 4;
    auto n = 6;
    vector<int> s{1, 2, 3, 4, 5, 6};
    auto result = ScoreboardInference::getMinProblemCount(n, s);
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_3) {
    auto expected = 4;
    auto n = 4;
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_fail_1) {
    // 1 ≤ n
    auto n = 1 - 1;
    vector<int> s{1, 2, 3, 4, 5, 6};
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_fail_2) {
    // n ≤ 500,000
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_fail_3) {
    // 1 ≤ si
    auto n = 10;
    auto size = 1 - 1;
...
TEST(Interview_ScoreboardInferenceCh1Test, getMinProblemCount_fail_4) {
    // si ≤ 1,000,000,000
    auto n = 10;
