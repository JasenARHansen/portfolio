...
TEST(Interview_ElementSwappingTest, description) {
    testing::internal::CaptureStdout();
    ElementSwapping::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(Interview_ElementSwappingTest, findMinArray_1) {
...
TEST(Interview_ElementSwappingTest, findMinArray_2) {
...
TEST(Interview_ElementSwappingTest, findMinArray_3) {
...
TEST(Interview_ElementSwappingTest, findMinArray_4) {
...
TEST(Interview_ElementSwappingTest, findMinArray_fail_1) {
    // 1 ≤ arr.length
    auto size = 1 - 1;
    vector<int> arr(size);
    auto k = 3;
...
TEST(Interview_ElementSwappingTest, findMinArray_fail_2) {
    // arr.length ≤ 10^3
...
TEST(Interview_ElementSwappingTest, findMinArray_fail_3) {
    // 1 ≤ k
    vector<int> arr{8, 9, 11, 2, 1};
    auto k = 1 - 1;
    EXPECT_EXIT(ElementSwapping::findMinArray(arr, k), ::testing::ExitedWithCode(3), "");
...
TEST(Interview_ElementSwappingTest, findMinArray_fail_4) {
    // k ≤ 10^3
    vector<int> arr{8, 9, 11, 2, 1};
