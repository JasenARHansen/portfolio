...
#include "../../../../../code/interview/meta/preparation/search/RevenueMilestones.cpp"  // NOLINT : Ignore .cpp import

TEST(Interview_RevenueMilestonesTest, description) {
    testing::internal::CaptureStdout();
    RevenueMilestones::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(Interview_RevenueMilestonesTest, getMilestoneDays_1) {
...
TEST(Interview_RevenueMilestonesTest, getMilestoneDays_2) {
...
TEST(Interview_RevenueMilestonesTest, getMilestoneDays_3) {
