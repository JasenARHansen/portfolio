...
TEST(Interview_BillionUsersTest, description) {
    testing::internal::CaptureStdout();
    BillionUsers::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(Interview_BillionUsersTest, getBillionUsersDay_1) {
    auto expected = 52;
...
TEST(Interview_BillionUsersTest, getBillionUsersDay_2) {
    auto expected = 79;
...
TEST(Interview_BillionUsersTest, getBillionUsersDay_3) {
    auto expected = 1047;
