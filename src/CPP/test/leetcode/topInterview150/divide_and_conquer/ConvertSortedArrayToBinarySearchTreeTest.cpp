...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, description) {
    testing::internal::CaptureStdout();
    ConvertSortedArrayToBinarySearchTree::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_1) {
...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_2) {
...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_fail_1) {
    // 1 ≤ nums.length
    int size = 1 - 1;
...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_fail_2) {
    // nums.length ≤ 10^4
...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_fail_3) {
    // -10^4 ≤ nums[i]
    int size = (int) -pow(10, 4) - 1;
    vector<int> nums{size};
    EXPECT_EXIT(ConvertSortedArrayToBinarySearchTree::sortedArrayToBST(nums), ::testing::ExitedWithCode(3), "");
...
TEST(LeetCode_ConvertSortedArrayToBinarySearchTreeTest, climbStairs_fail_4) {
    // nums[i] ≤ 10^4
    int size = (int) pow(10, 4) + 1;
    vector<int> nums{size};
    EXPECT_EXIT(ConvertSortedArrayToBinarySearchTree::sortedArrayToBST(nums), ::testing::ExitedWithCode(3), "");
