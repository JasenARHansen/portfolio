...
TEST(LeetCode_SummaryRangesTest, description) {
    testing::internal::CaptureStdout();
    SummaryRanges::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_SummaryRangesTest, summaryRanges_1) {
...
TEST(LeetCode_SummaryRangesTest, summaryRanges_2) {
...
TEST(LeetCode_SummaryRangesTest, summaryRanges_3) {
...
TEST(LeetCode_SummaryRangesTest, summaryRanges_fail_1) {
    // nums.length ≤ 20
    auto size = 20 + 1;
