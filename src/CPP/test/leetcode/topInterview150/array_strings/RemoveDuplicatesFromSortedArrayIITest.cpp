...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, description) {
    testing::internal::CaptureStdout();
    RemoveDuplicatesFromSortedArrayII::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_1) {
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_2) {
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_1) {
    // 1 ≤ nums.length
    auto size = 0;
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_2) {
    // nums.length ≤ 3 * 10^4
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_3) {
    // -10^4 ≤ nums[i]
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_4) {
    // nums[i] ≤ 10^4
    auto value = (int) pow(10, 4) + 1;
    vector<int> nums{value};
    EXPECT_EXIT(RemoveDuplicatesFromSortedArrayII::removeDuplicates(nums), ::testing::ExitedWithCode(3), "");
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_5) {
    // nums[i] ≤ 10^4
    auto value = (int) pow(10, 4) + 1;
...
TEST(LeetCode_RemoveDuplicatesFromSortedArrayIITest, removeDuplicates_fail_6) {
