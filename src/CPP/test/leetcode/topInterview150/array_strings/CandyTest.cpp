...
TEST(LeetCode_CandyTest, description) {
    testing::internal::CaptureStdout();
    Candy::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_CandyTest, candy_1) {
    auto expected = 5;
...
TEST(LeetCode_CandyTest, candy_2) {
    auto expected = 4;
...
TEST(LeetCode_CandyTest, candy_3) {
    auto expected = 6;
...
TEST(LeetCode_CandyTest, candy_4) {
    auto expected = 6;
...
TEST(LeetCode_CandyTest, candy_fail_1) {
    // 1 ≤ ratings.length
    auto size = 1 - 1;
...
TEST(LeetCode_CandyTest, candy_fail_2) {
    // ratings.length ≤ 10^4
...
TEST(LeetCode_CandyTest, candy_fail_3) {
    // 0 ≤ ratings[i]
    auto value = 0 - 1;
...
TEST(LeetCode_CandyTest, candy_fail_4) {
    // ratings[i] ≤ 2 * 10^4
