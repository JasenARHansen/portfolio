...
TEST(LeetCode_ProductOfArrayExceptSelfTest, description) {
    testing::internal::CaptureStdout();
    ProductOfArrayExceptSelf::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_1) {
...
TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_2) {
...
TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_fail_1) {
    // 2 ≤ nums.length
    auto size = 2 - 1;
...
TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_fail_2) {
    // nums.length ≤ 10^5
...
TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_fail_3) {
    // -30 ≤ nums[i]
    auto value = -30 - 1;
...
TEST(LeetCode_ProductOfArrayExceptSelfTest, productExceptSelf_fail_4) {
    // nums[i] ≤ 30
    auto value = 30 + 1;
    vector<int> nums{1, value, 1};
    EXPECT_EXIT(ProductOfArrayExceptSelf::productExceptSelf(nums), ::testing::ExitedWithCode(3), "");
