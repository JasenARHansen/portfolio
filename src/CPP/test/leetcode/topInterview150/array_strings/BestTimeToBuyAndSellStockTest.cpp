...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, description) {
    testing::internal::CaptureStdout();
    BestTimeToBuyAndSellStock::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_1) {
    auto expected = 5;
...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_2) {
    auto expected = 0;
...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_fail_1) {
    // 1 ≤ prices.length
    auto size = 0;
...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_fail_2) {
    // prices.length ≤ 10^5
...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_fail_3) {
    // 0 ≤ prices[i]
    auto value = -1;
...
TEST(LeetCode_BestTimeToBuyAndSellStockTest, maxProfit_fail_4) {
    // prices[i] ≤ 10^4
