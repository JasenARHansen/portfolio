...
TEST(LeetCode_MajorityElementTest, description) {
    testing::internal::CaptureStdout();
    MajorityElement::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_MajorityElementTest, majorityElement_1) {
    auto expected = 3;
...
TEST(LeetCode_MajorityElementTest, majorityElement_2) {
    auto expected = 2;
...
TEST(LeetCode_MajorityElementTest, majorityElement_fail_1) {
    // 1 ≤ nums.length
    auto size = 0;
...
TEST(LeetCode_MajorityElementTest, majorityElement_fail_2) {
    // nums.length ≤ 5 * 10^4
...
TEST(LeetCode_MajorityElementTest, majorityElement_fail_3) {
    // -10^9 ≤ nums[i]
...
TEST(LeetCode_MajorityElementTest, majorityElement_fail_4) {
    // nums[i] ≤ 10^9
    auto value = (int) pow(10, 9) + 1;
    vector<int> nums{value};
    EXPECT_EXIT(MajorityElement::majorityElement(nums), ::testing::ExitedWithCode(3), "");
...
TEST(LeetCode_MajorityElementTest, majorityElement_fail_5) {
    // nums[i] ≤ 109
    auto value = (int) pow(10, 9) + 1;
