...
TEST(LeetCode_AverageOfLevelsInBinaryTreeTest, description) {
    testing::internal::CaptureStdout();
    AverageOfLevelsInBinaryTree::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_AverageOfLevelsInBinaryTreeTest, averageOfLevels_1) {
...
TEST(LeetCode_AverageOfLevelsInBinaryTreeTest, averageOfLevels_2) {
    vector<double> expected{3.00000, 14.50000, 11.00000};
...
TEST(LeetCode_AverageOfLevelsInBinaryTreeTest, averageOfLevels_3) {
...
TEST(LeetCode_AverageOfLevelsInBinaryTreeTest, averageOfLevels_4) {
