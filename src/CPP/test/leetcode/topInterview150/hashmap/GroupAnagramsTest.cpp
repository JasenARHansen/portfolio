...
TEST(LeetCode_GroupAnagramsTest, description) {
    testing::internal::CaptureStdout();
    GroupAnagrams::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_GroupAnagramsTest, groupAnagrams_1) {
...
TEST(LeetCode_GroupAnagramsTest, groupAnagrams_2) {
...
TEST(LeetCode_GroupAnagramsTest, groupAnagrams_3) {
...
TEST(LeetCode_GroupAnagramsTest, groupAnagrams_fail_1) {
    // 1 ≤ strings.length
    auto size = 1 - 1;
...
TEST(LeetCode_GroupAnagramsTest, groupAnagrams_fail_2) {
    // strings.length ≤ 10^4
...
TEST(LeetCode_GroupAnagramsTest, groupAnagrams_fail_3) {
