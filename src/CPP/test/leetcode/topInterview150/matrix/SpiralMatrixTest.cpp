...
TEST(LeetCode_SpiralMatrixTest, description) {
    testing::internal::CaptureStdout();
    SpiralMatrix::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_SpiralMatrixTest, spiralOrder_1) {
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_2) {
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_3) {
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_4) {
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_5) {
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_fail_1) {
    // 1 ≤ matrix.length
    auto size = 1 - 1;
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_fail_2) {
    // matrix.length ≤ 10
    auto size = 10 + 1;
    vector<vector<int>> matrix(size);
    EXPECT_EXIT(SpiralMatrix::spiralOrder(matrix), ::testing::ExitedWithCode(3), "");
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_fail_3) {
    // 1 ≤ matrix[i].length
    auto size = 1 - 1;
...
TEST(LeetCode_SpiralMatrixTest, spiralOrder_fail_4) {
    // matrix[i].length ≤ 10
    auto size = 10 + 1;
    vector<vector<int>> matrix{vector<int>(size)};
    EXPECT_EXIT(SpiralMatrix::spiralOrder(matrix), ::testing::ExitedWithCode(3), "");
