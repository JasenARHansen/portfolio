...
TEST(LeetCode_LetterCombinationsOfAPhoneNumberTest, description) {
    testing::internal::CaptureStdout();
    LetterCombinationsOfAPhoneNumber::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_LetterCombinationsOfAPhoneNumberTest, letterCombinations_1) {
...
TEST(LeetCode_LetterCombinationsOfAPhoneNumberTest, letterCombinations_2) {
...
TEST(LeetCode_LetterCombinationsOfAPhoneNumberTest, letterCombinations_3) {
