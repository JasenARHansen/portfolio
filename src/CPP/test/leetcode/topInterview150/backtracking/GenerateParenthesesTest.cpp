...
TEST(GenerateParenthesesTest, generateParenthesis_1) {
...
TEST(GenerateParenthesesTest, generateParenthesis_2) {
    vector<string> expected{"()"};
    int n = 1;
    auto result = GenerateParentheses::generateParenthesis(n);
    EXPECT_EQ(expected, result);
...
TEST(GenerateParenthesesTest, generateParenthesis_3) {
    vector<string> expected{"(((())))", "((()()))", "((())())", "((()))()", "(()(()))", "(()()())", "(()())()",
                            "(())(())", "(())()()", "()((()))", "()(()())", "()(())()", "()()(())", "()()()()"};
    int n = 4;
    auto result = GenerateParentheses::generateParenthesis(n);
