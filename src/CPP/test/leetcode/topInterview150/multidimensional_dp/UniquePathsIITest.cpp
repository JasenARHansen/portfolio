...
TEST(LeetCode_UniquePathsIITest, description) {
    testing::internal::CaptureStdout();
    UniquePathsII::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_1) {
    auto expected = 2;
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_2) {
    auto expected = 1;
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_3) {
    auto expected = 0;
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_4) {
    auto expected = 0;
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_5) {
    auto expected = 0;
    vector<vector<int>> obstacleGrid{{1},
                                     {0}};
    auto result = UniquePathsII::uniquePathsWithObstacles(obstacleGrid);
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_fail_1) {
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_fail_2) {
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_fail_3) {
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_fail_4) {
...
TEST(LeetCode_UniquePathsIITest, uniquePathsWithObstacles_fail_5) {
