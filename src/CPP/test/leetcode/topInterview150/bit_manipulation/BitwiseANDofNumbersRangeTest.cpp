...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, description) {
    testing::internal::CaptureStdout();
    BitwiseANDofNumbersRange::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_1) {
    auto expected = 4;
    auto left = 5;
    auto right = 7;
...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_2) {
    auto expected = 0;
    auto left = 0;
    auto right = 0;
    auto result = BitwiseANDofNumbersRange::rangeBitwiseAnd(left, right);
...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_3) {
    auto expected = 0;
    auto left = 1;
...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_fail_1) {
    // 0 ≤ left
    auto left = 0 - 1;
    auto right = 7;
...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_fail_2) {
    // 0 ≤ right
    auto left = 5;
    auto right = 0 - 1;
    EXPECT_EXIT(BitwiseANDofNumbersRange::rangeBitwiseAnd(left, right), ::testing::ExitedWithCode(3), "");
...
TEST(LeetCode_BitwiseANDofNumbersRangeTest, rangeBitwiseAnd_fail_3) {
    // left ≤ right
    auto left = 5;
    auto right = left - 1;
    EXPECT_EXIT(BitwiseANDofNumbersRange::rangeBitwiseAnd(left, right), ::testing::ExitedWithCode(3), "");
