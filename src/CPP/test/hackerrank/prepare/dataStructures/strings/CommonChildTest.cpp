...
TEST(HackerRank_CommonChildTest, description) {
    testing::internal::CaptureStdout();
    CommonChild::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}
/*
TEST(HackerRank_CommonChildTest, commonChild_1) {
    auto expected = 3;
    auto s1 = "ABCD";
    auto s2 = "ABDC";
...
TEST(HackerRank_CommonChildTest, commonChild_2) {
    auto expected = 2;
    auto s1 = "HARRY";
    auto s2 = "SALLY";
    auto result = CommonChild::commonChild(s1, s2);
...
TEST(HackerRank_CommonChildTest, commonChild_3) {
    auto expected = 0;
    auto s1 = "AA";
    auto s2 = "BB";
    auto result = CommonChild::commonChild(s1, s2);
...
TEST(HackerRank_CommonChildTest, commonChild_4) {
    auto expected = 3;
    auto s1 = "SHINCHAN";
    auto s2 = "NOHARAAA";
    auto result = CommonChild::commonChild(s1, s2);
