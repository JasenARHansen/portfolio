...
TEST(LargestRectangleTest, largestRectangle_1) {
    auto expected = 6;
...
TEST(LargestRectangleTest, largestRectangle_2) {
    auto expected = 9;
...
TEST(LargestRectangleTest, largestRectangle_3) {
    auto expected = 50;
...
TEST(LargestRectangleTest, largestRectangle_4) {
    auto expected = 11;
...
TEST(LargestRectangleTest, largestRectangle_5) {
    auto expected = 18;
...
TEST(LargestRectangleTest, largestRectangle_6) {
    auto expected = 6;
...
TEST(LargestRectangleTest, largestRectangle_7) {
    auto expected = 9;
...
TEST(LargestRectangleTest, largestRectangle_8) {
    auto expected = 9;
