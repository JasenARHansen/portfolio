...
TEST(HackerRank_QueueUsingTwoStacksTest, description) {
    testing::internal::CaptureStdout();
    QueueUsingTwoStacks::description();
    EXPECT_NE("", testing::internal::GetCapturedStdout());
}

TEST(HackerRank_QueueUsingTwoStacksTest, queueOperations_1) {
...
TEST(HackerRank_QueueUsingTwoStacksTest, queueOperations_2) {
