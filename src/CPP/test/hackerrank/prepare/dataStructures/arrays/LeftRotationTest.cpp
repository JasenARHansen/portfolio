...
TEST(LeftRotationTest, rotateLeft_1) {
...
TEST(LeftRotationTest, rotateLeft_2) {
...
TEST(LeftRotationTest, rotateLeft_3) {
...
TEST(LeftRotationTest, rotateLeft_4) {
...
TEST(LeftRotationTest, rotateLeft_5) {
    vector<int> expected{2, 3, 4, 5, 1};
    vector<int> arr{1, 2, 3, 4, 5};
    int d = arr.size() + 1;
    auto result = LeftRotation::rotateLeft(d, arr);
...
TEST(LeftRotationTest, rotateLeft_6) {
    vector<int> expected{5, 1, 2, 3, 4};
    vector<int> arr{1, 2, 3, 4, 5};
    auto d = -1;
    auto result = LeftRotation::rotateLeft(d, arr);
...
TEST(LeftRotationTest, rotateLeft_7) {
    vector<int> expected{5, 1, 2, 3, 4};
    vector<int> arr{1, 2, 3, 4, 5};
    int d = -arr.size() - 1;
    auto result = LeftRotation::rotateLeft(d, arr);
