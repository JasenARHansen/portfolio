...
public:
    ...
    static vector<pair<int, string>> serializeListRandomPointer(Node *head) {
    ...
    static Node *deserializeListRandomPointer(const vector<pair<int, string>> &numbers) {
    ...
    static Node *copyRandomList(Node *head) {
        ...
        if (head != nullptr) {
            ...
            source = head;
            result = new Node(source->val);
            auto current = result;
            indexes.push_back(current);
            while (source->next != nullptr) {
                current->next = new Node(source->next->val);
