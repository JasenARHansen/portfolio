...
public:
    ...
    Letters cannot be rearranged. Given two strings of equal length, what's the longest string
    ...
    Explanation:
        The longest string that can be formed by deleting zero or more characters from HARRY and SALLY
    ...
    Explanation 3:
        BD is the longest child of the given strings.)" << endl;
    }
