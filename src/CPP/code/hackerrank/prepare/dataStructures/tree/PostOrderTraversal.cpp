...
public:
    static void description() {
        cout << R"(Tree: Postorder Traversal
    Complete the postOrder function in the editor below, which has 1 parameter: a pointer to the root of a binary tree.
    ...
    Sample Output:
        4 3 6 5 2 1
    Explanation:
        The postorder traversal of the binary tree is printed.)" << endl;
    }
    ...
    static void postOrder(Node *node, string *output) {
