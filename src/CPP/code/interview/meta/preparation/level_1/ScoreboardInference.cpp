...
public:
    ...
    You are spectating a programming contest with NN competitors, each trying to independently solve the
     same set of programming problems.
    Each problem has a point value, which is either 1 or 2.
    On the scoreboard, you observe that the Ith competitor has attained a score of Si, which is a
    ...
    Sample test case #3
        ...
        Expected Return Value = 4
    Sample Explanation:
        In the first case, it's possible that there are as few as 4 problems in the contest, for
     example with point values[1, 1, 2, 2].
