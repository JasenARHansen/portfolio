...
public:
    ...
    Sample Explanation
        In the first case, the discs (from top to bottom) have radii of [2", 5", 3", 6", 5"]. One optimal way to stabilize the stack is by deflating disc 1 from 2" to 1", deflating disc 2 from 5"5" to 2"2", and deflating disc 44 from 6"6" to 4"4". This yields final radii of [1", 2", 3", 4", 5"].
