...
public:
    ...
    Input:
        revenues is a length-N array representing how much revenue FB made on each day (from day 1
         to day N).
    ...
    Explanation:
        ...
        Day 6 is the first time that FB has >= $200 of total revenue.)" << endl;
    }
