...
public class PowersOfBaseTest {
    ...
    public void getNPowersOfBase_10_1() {
        ...
        System.out.format(
                "\tThe string '%s' with a numeric base of '%d' splits '%d' times into values that"
                        + " are a power of '%d' '%s'\n",
                input, numberBase, result.size(), powerBase, result);
    }
    ...
    public void validatePowerOfBase_10_1() {
        ...
        assertTrue(result);
        System.out.format(
                "\tThe string '%s' with a numeric base of '%d' is a power of '%d': %b\n",
                input, numberBase, powerBase, result);
    }
