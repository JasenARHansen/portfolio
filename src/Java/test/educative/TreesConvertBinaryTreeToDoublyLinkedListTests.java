...
import Java.code.educative.TreesConvertBinaryTreeToDoublyLinkedList;
import Java.code.educative.TreesConvertBinaryTreeToDoublyLinkedList.Node;
...
public class TreesConvertBinaryTreeToDoublyLinkedListTests {
    ...
    public void convert_to_linked_list_1() {
        ...
        for (int index = 0; index < result.size(); index++) {
            System.out.format(
                    """
                            \tIn the new linked list, element %d is '%s'
