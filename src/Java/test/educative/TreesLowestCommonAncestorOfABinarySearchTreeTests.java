...
public class TreesLowestCommonAncestorOfABinarySearchTreeTests {
    ...
    public void level_order_traversal_1() {
        ...
        System.out.format(
                "\tThe lowest common ancestor of %d and %d in the tree starting with %d is %d.\n",
                N_2.data, N_8.data, N_6.data, result.data);
    ...
    public void level_order_traversal_2() {
        ...
        System.out.format(
                "\tThe lowest common ancestor of %d and %d in the tree starting with %d is %d.\n",
                N_2.data, N_4.data, N_6.data, result.data);
    ...
    public void level_order_traversal_3() {
        ...
        System.out.format(
                "\tThe lowest common ancestor of %d and %d in the tree starting with %d is %d.\n",
                N_2.data, N_1.data, N_2.data, result.data);
        assertEquals(N_2, result);
    }
    ...
    public void level_order_traversal_4() {
        ...
        System.out.format(
                "\tThe lowest common ancestor of %d and %d in the tree starting with %d is %d.\n",
                N_5.data, N_0.data, N_6.data, result.data);
        assertEquals(N_2, result);
    }
    ...
    public void level_order_traversal_5() {
        ...
        System.out.format(
                "\tThe lowest common ancestor of %d and %d in the tree starting with %d is %s.\n",
                N_5.data, N_9.data, N_2.data, result);
        assertNull(result);
    }
}
