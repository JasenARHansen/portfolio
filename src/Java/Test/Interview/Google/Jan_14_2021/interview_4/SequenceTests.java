...
public class SequenceTests {
  ...
  public void XofAKind_1() throws Exception {
    ...
    boolean result = Java.Code.Interview.Google.Jan_14_2021.interview_4.Sequence.XofAKind(inputs);
    System.out.format(
  ...
  public void XofAKind_6() throws Exception {
    Java.Code.Interview.Google.Jan_14_2021.interview_4.Sequence.XofAKind(null);
  }

  @Test
  public void straights_1() throws Exception {
    ArrayList<Integer> inputs = new ArrayList<>(List.of(1, 2, 3, 4, 5, 6));
    boolean result = Java.Code.Interview.Google.Jan_14_2021.interview_4.Sequence.straights(inputs);
    System.out.format(
