...
@SuppressWarnings({"NewClassNamingConvention", "DuplicatedCode", "GrazieInspection"})
...
public class Q4_07_Build_Order_Test {
  ...
  public static String[] buildOrderWrapper_Edge_Removal(
    ...
    Java.Code.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Project[]
  ...
  public static Java.Code.CTCI
          .CTCI_SOURCE
          .other
          .Ch_04_Trees_and_Graphs
          .Q4_07_Build_Order
          .EdgeRemoval
          .Project
      [] findBuildOrder(String[] projects, String[][] dependencies) {
    Java.Code.CTCI.CTCI_SOURCE.other.Ch_04_Trees_and_Graphs.Q4_07_Build_Order.EdgeRemoval.Graph
        graph = buildGraph_Edge_Removal(projects, dependencies);
