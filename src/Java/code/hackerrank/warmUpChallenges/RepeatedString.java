...
@SuppressWarnings({"SuspiciousIntegerDivAssignment", "SpellCheckingInspection", "GrazieInspection"})
public class RepeatedString {
  ...
  The substring we consider is 'abcacabcac', the first 10 characters of the infinite string. There are 4
   occurrences of an in the substring.
  ...
  Returns
      int: the frequency of an in the substring
  Input Format
