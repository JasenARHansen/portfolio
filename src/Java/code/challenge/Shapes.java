...
public class Shapes {
  ...
  // Set Default Values
  static final char defaultSymbol1 = '#';
  static final char defaultSymbol2 = '%';
  static final char defaultInscribedSymbol = ' ';
  ...
  public static void triangleLeftJustifiedPointDown(
      int count, boolean inscribed, char... symbolIn) {
  ...
  public static void triangleRightJustifiedPointDown(
      int count, boolean inscribed, char... symbolIn) {
    char symbol1 = symbolIn.length > 0 ? symbolIn[0] : defaultSymbol1;
    char symbol2 = symbolIn.length > 1 ? symbolIn[1] : defaultInscribedSymbol;
    if (count > 0) {
    ...
    if (count > 1) {
      for (int i = 1; i < count - 1; i++) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i)
                  + inscribedLine(count - i, symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i)
                  + String.valueOf(symbol1).repeat(count - i));
        }
      }
  ...
  public static void triangleRightJustifiedPointUp(int count, boolean inscribed, char... symbolIn) {
    ...
    if (count > 1) {
      for (int i = 1; i < count - 1; i++) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(count - i - 1)
                  + inscribedLine(i + 1, symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(count - i - 1)
                  + String.valueOf(symbol1).repeat(i + 1));
        }
      }
      System.out.println(String.valueOf(symbol1).repeat(count));
    }
  ...
  public static void trianglePointDown(int count, boolean inscribed, char... symbolIn) {
    ...
    if (count > 1) {
      for (int i = count - 1; i > 1; i--) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(count - i)
                  + inscribedLine((2 * i) - 1, symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(count - i)
                  + String.valueOf(symbol1).repeat((2 * i) - 1));
        }
      }
      System.out.println(String.valueOf(defaultInscribedSymbol).repeat(count - 1) + symbol1);
    }
    ...
    if (count > 1) {
      for (int i = 2; i <= count - 1; i++) {
        if (inscribed || (symbolIn.length > 1)) {
          ...
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(Math.max(0, count - i))
                  + String.valueOf(symbol1).repeat(((2 * i) - 1)));
        }
      }
  ...
  public static void diamond(int count, boolean inscribed, char... symbolIn) {
    ...
    if (count > 1) {
      ...
      for (int i = 0; i < count - 1; i++) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i + 1)
                  + inscribedLine(2 * (count - 1 - i) - 1, symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i + 1)
                  + String.valueOf(symbol1).repeat(2 * (count - 1 - i) - 1));
        }
      }
    }
  }
  ...
  public static void splitSquarePointDown(int count, char... symbolIn) {
    ...
    for (int i = 0; i < count; i++) {
      System.out.println(
          String.valueOf(symbol1).repeat(i) + String.valueOf(symbol2).repeat(count - i));
    }
  }
  ...
  public static void splitSquarePointUp(int count, char... symbolIn) {
    ...
    for (int i = 1; i <= count; i++) {
      System.out.println(
          String.valueOf(symbol1).repeat(count - i) + String.valueOf(symbol2).repeat(i));
    }
  }
  ...
  public static void hexagon(int count, boolean inscribed, char... symbolIn) {
    ...
    if (count > 0) {
      System.out.println(
          String.valueOf(defaultInscribedSymbol).repeat(count - 1)
              + String.valueOf(symbol1).repeat(count));
    }
    if (count > 1) {
      for (int i = count - 1; i > 0; i--) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i - 1)
                  + inscribedLine(count + 2 * (count - i), symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i - 1)
                  + String.valueOf(symbol1).repeat((count + 2 * (count - i))));
        }
      }
      ...
      for (int i = 0; i < count - 1; i++) {
        if (inscribed || (symbolIn.length > 1)) {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i)
                  + inscribedLine((3 * count - 2) - 2 * i, symbol1, symbol2));
        } else {
          System.out.println(
              String.valueOf(defaultInscribedSymbol).repeat(i)
                  + String.valueOf(symbol1).repeat(((3 * count - 2) - 2 * i)));
        }
      }
      System.out.println(
          String.valueOf(defaultInscribedSymbol).repeat(count - 1)
