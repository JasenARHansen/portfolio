...
@SuppressWarnings({"SameParameterValue", "unused", "CommentedOutCode", "SuspiciousNameCombination"})
public class GoogleBitMap {
  ...
  private static void floodFill(
    ...
    while (!floodQueue.isEmpty()) {
      ...
      // Boundary check
      Integer newX = current.leftData;
      Integer newY = current.rightData;
  ...
  public record GoogleTuple<X extends Comparable<X>, Y extends Comparable<Y>>(
      X leftData, Y rightData) implements Comparable<GoogleTuple<X, Y>> {
