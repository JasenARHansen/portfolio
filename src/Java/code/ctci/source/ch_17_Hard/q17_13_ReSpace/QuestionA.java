...
public class QuestionA {
    ...
    public static void main(String[] args) {
        ...
        String sentence =
                "As one of the top companies in the world, Google will surely attract the attention"
                        + " of computer gurus. This does not, however, mean the company is for everyone.";
