...
public class SubstringPermutationOfLargerString {
  ...
  public static void getDescription() {
    System.out.println(
        "Given a small string and a larger string.  Find all permustiaons of smaller string"
            + " that withinthe larger string. Print all locations of the smaller string.");
  }
