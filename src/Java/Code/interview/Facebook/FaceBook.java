package Java.code.interview.Facebook;
...
public class FaceBook {
  ...
  public static <T extends Comparable<T>> void printPathsData(
      BinarySearchTreeHeightBalanced<T> tree) {
    ArrayList<T> paths = new ArrayList<>();
    printPathsData(tree.getRoot(), paths);
  }

  public static <T extends Comparable<T>> void printPathsNode(
      BinarySearchTreeHeightBalanced<T> tree) {
  ...
  private static <T extends Comparable<T>> void printPathsData(
      NodeTree<T> node, ArrayList<T> paths) {
  ...
  private static <T extends Comparable<T>> void printPathsNode(
      NodeTree<T> node, ArrayList<NodeTree<T>> nodes) {
    if ((node.getLeftChild() == null) && (node.getRightChild() == null)) {
