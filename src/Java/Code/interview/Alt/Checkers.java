package Java.code.interview.Alt;
...
public class Checkers {
  ...
  public static final String first_initial = "x";
  public static final String second_Player = "O";
  public static final String second_initial = "o";
  static String[][] board;

  public static void getDescription() {
    System.out.println(
        """
                Generate a Checker board and provide possible moves.  Do not implement jumping.."""
            .indent(2));
  }
