package Java.Code.CTCI.CTCI_SOURCE.other.Ch_02_Linked_Lists.Q2_01_Remove_Duplicates;
        ...
        while (current != null) {
            ...
            while (runner != current) {
                if (runner.data == current.data) {
                    ...
                    previous.next = tmp;
                    current = tmp;
                    /* We know we can't have more than one duplicate preceding
             ...
             * condition, in which case we found a duplicate and current has
