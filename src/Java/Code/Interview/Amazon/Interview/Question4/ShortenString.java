package Java.Code.Interview.Amazon.Interview.Question4;
...
public class ShortenString {
    ...
    public static void getDescription() {
        System.out.println("""
                ...
                The shortening process has 3 parts.
                    ...
                    - Part 2 : An integer representation of the count of internal characters (Non displayed characters)
                ...
                Question 4: if prefix size is greater than string, return string
                ...
                Note that the shortest representation for the first two elements is "a3c" but we cannot return that value as it violates the uniqueness constraint.""".indent(2));
    }
    ...
    public static String Shorten(String input_string, int prefix_size) {
        ...
        return input_string.substring(0, prefix_size) + (input_string.length() - prefix_size - 1) + input_string.charAt(input_string.length() - 1);
    }
