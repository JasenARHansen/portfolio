...
public class ListsAddTwoNumbersAsAList {
  /*
    ...
    Approach: Traverse both lists and One by one pick nodes of both lists and add the values. If the sum is more than
     10 then make carry as 1 and reduce sum. If one list has more elements than the other than consider remaining
    ...
    Complexity Analysis:
      ...
      The lists will need to be traversed only once.
