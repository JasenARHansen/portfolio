...
import classesInstance.Car;
import interfaces.GreetingService;
...
public class Java8Tester {
	...
	private static void section2() {
		...
		System.out.println("10 + 5 = " + interfaces.MathOperation.operate(10, 5, addition));
		System.out.println("10 - 5 = " + interfaces.MathOperation.operate(10, 5, subtraction));
		System.out.println("10 x 5 = " + interfaces.MathOperation.operate(10, 5, multiplication));
		System.out.println("10 / 5 = " + interfaces.MathOperation.operate(10, 5, division));
	...
	private static void section3() {
		...
		GreetingService greetService3 = message -> System.out.println(interfaces.GreetingService.salutation + message);
