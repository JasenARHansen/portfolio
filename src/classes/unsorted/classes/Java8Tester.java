package classes.unsorted.classes;

import classes.classesInstance.Car;
import classes.unsorted.interfaces.GreetingService;
import classes.unsorted.interfaces.MathOperation;
...
public class Java8Tester {
	...
	private static void section2() {
        ...
        System.out.println("10 + 5 = " + classes.unsorted.interfaces.MathOperation.operate(10, 5, addition));
        System.out.println("10 - 5 = " + classes.unsorted.interfaces.MathOperation.operate(10, 5, subtraction));
        System.out.println("10 x 5 = " + classes.unsorted.interfaces.MathOperation.operate(10, 5, multiplication));
        System.out.println("10 / 5 = " + classes.unsorted.interfaces.MathOperation.operate(10, 5, division));
	...
	private static void section3() {
        ...
        GreetingService greetService3 = message -> System.out.println(classes.unsorted.interfaces.GreetingService.salutation + message);
    ...
    private Integer sum(@SuppressWarnings("OptionalUsedAsFieldOrParameterType") Optional<Integer> a, @SuppressWarnings("OptionalUsedAsFieldOrParameterType") Optional<Integer> b) {
