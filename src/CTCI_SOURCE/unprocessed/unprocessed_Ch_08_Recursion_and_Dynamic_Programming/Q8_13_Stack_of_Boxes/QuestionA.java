package CTCI_SOURCE.unprocessed.unprocessed_Ch_08_Recursion_and_Dynamic_Programming.Q8_13_Stack_of_Boxes;
...
public class QuestionA {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Box> boxes = new ArrayList<>(Arrays.asList(boxList));
