...
public class Q3_01_Three_in_One_QuestionB {
    public static void printStacks(Q3_01_Three_in_One_MultiStack stacks) {
    ...
    public static void main(String[] args) throws Exception {
        Q3_01_Three_in_One_MultiStack stacks = new Q3_01_Three_in_One_MultiStack(3, 4);
        printStacks(stacks);
        stacks.push(0, 10);
        printStacks(stacks);
        stacks.push(1, 20);
