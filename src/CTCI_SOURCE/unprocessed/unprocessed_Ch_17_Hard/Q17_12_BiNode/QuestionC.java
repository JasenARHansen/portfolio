package CTCI_SOURCE.unprocessed.unprocessed_Ch_17_Hard.Q17_12_BiNode;
...
public class QuestionC {
    ...
    public static BiNode convertToCircular(BiNode root) {
        ...
        /* join left to root */
        concat(Objects.requireNonNullElse(part1, part3).node1, root);

        /* join right to root */
        concat(root, Objects.requireNonNullElse(part3, part1));
