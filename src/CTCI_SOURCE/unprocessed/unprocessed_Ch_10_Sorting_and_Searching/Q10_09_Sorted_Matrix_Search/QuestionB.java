package CTCI_SOURCE.unprocessed.unprocessed_Ch_10_Sorting_and_Searching.Q10_09_Sorted_Matrix_Search;

import CTCI.CtCILibrary.AssortedMethods;

public class QuestionB {

    public static Coordinate partitionAndSearch(int[][] matrix, Coordinate origin, Coordinate dest, Coordinate pivot, int x) throws CloneNotSupportedException {
    ...
    public static Coordinate findElement(int[][] matrix, Coordinate origin, Coordinate dest, int x) throws CloneNotSupportedException {
    ...
    public static Coordinate findElement(int[][] matrix, int x) throws CloneNotSupportedException {
