package CTCI_SOURCE.unprocessed.Ch_16_Moderate.Q16_13_Bisect_Squares;
...
public class Question {
    ...
    public static boolean doTest(Square s1, Square s2, Point start, Point end) {
        Line q16_03_Intersection_Line = s1.cut(s2);
        boolean r = (isApproxEqual(q16_03_Intersection_Line.start, start) && isApproxEqual(q16_03_Intersection_Line.end, end)) || (isApproxEqual(q16_03_Intersection_Line.start, end) && isApproxEqual(q16_03_Intersection_Line.end, start));
        if (!r) {
            printSquare(s1);
            printSquare(s2);
            printLine(q16_03_Intersection_Line);
