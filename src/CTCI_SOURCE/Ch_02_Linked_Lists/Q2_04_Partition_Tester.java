...
public class Q2_04_Partition_Tester {
    ...
    public static void main(String[] args) {
        ...
        /* Partition */
        LinkedListNode hA = Q2_04_Partition_Question.partition(createLinkedList(), 5);
        LinkedListNode hB = Q2_04_Partition_QuestionB.partition(createLinkedList(), 5);
        LinkedListNode hC = Q2_04_Partition_QuestionC.partition(createLinkedList(), 5);
