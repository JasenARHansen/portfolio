package CTCI_SOURCE.unprocessed_Ch_17_Hard.Q17_24_Max_Submatrix;
...
public class QuestionC {
    public static SubMatrix getMaxMatrix(int[][] matrix) {
        ...
        for (int rowStart = 0; rowStart < rowCount; rowStart++) {
            ...
            for (int rowEnd = rowStart; rowEnd < rowCount; rowEnd++) {
                ...
                CTCI_SOURCE.unprocessed_Ch_17_Hard.Q17_24_Max_Submatrix.Range bestRange = maxSubArray(partialSum, colCount);
    ...
    public static CTCI_SOURCE.unprocessed_Ch_17_Hard.Q17_24_Max_Submatrix.Range maxSubArray(int[] array, int N) {
        CTCI_SOURCE.unprocessed_Ch_17_Hard.Q17_24_Max_Submatrix.Range best = null;
        int start = 0;
        int sum = 0;
