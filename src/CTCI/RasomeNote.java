...
public class RasomeNote {
    ...
    public static void getDescription() {
        System.out.println(
                "A ransome note can be formed by cutting words out of a magazine to form a new sentence. How would you figure out is a ransome note (represented as a string) can be formed from a given magazine (String)?");
    }
