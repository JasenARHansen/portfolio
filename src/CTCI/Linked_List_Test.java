...
public class Linked_List_Test {
	...
	private String testSuite = "Linked List";
	...
	public void intersects() {
		...
		System.out.format("List is intersects: %s\n", resultNode.toString());
		stringValue1.empty();
		stringValue2.empty();
		stringValue1.insert("a");
		stringValue1.insert("a");
	...
	public void sumList() {
		...
		intValue1.printList();
		intValue2.printList();
		CustomLinkedList<Integer> intValue3 = Linked_List.sumListReverse(intValue1, intValue2);
		System.out.println("Test 1 result:");
		intValue3.printList();
