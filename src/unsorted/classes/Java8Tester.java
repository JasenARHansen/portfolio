package unsorted.classes;

import unsorted.classesInstance.Car;
import unsorted.interfaces.GreetingService;
import unsorted.interfaces.MathOperation;
...
public class Java8Tester {
	...
	private static void section2() {
		...
		System.out.println("10 + 5 = " + unsorted.interfaces.MathOperation.operate(10, 5, addition));
		System.out.println("10 - 5 = " + unsorted.interfaces.MathOperation.operate(10, 5, subtraction));
		System.out.println("10 x 5 = " + unsorted.interfaces.MathOperation.operate(10, 5, multiplication));
		System.out.println("10 / 5 = " + unsorted.interfaces.MathOperation.operate(10, 5, division));
	...
	private static void section3() {
		...
		GreetingService greetService3 = message -> System.out.println(unsorted.interfaces.GreetingService.salutation + message);
